...
Library:Notify("Welcome BETTER KEEP USING MY SCIPT  drac.cc - " .. Username .. " 👏", 5)
task.wait(1) 

-- // Create Main UI Window
local Window = Library:CreateWindow({
    Title = 'drac.cc | ' .. tostring(identifyexecutor()),
    Center = true,
    AutoShow = true,
    TabPadding = 8,
    MenuFadeTime = 0.2
...
v11.MainColor = Color3.fromRGB(10, 10, 10)
v11.OutlineColor = Color3.fromRGB(5, 5, 5)
v11.AccentColor = Color3.fromRGB(170, 0, 255)
v11.Registry = {}
v11.RegistryMap = {}
v11.HudRegistry = {}
...
DupeBox:AddLabel("Click Buy KoolAid TO GET LEAN")
            ...
            if SelectedPlayer then
                if SelectedPlayer.Character and SelectedPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if localPlayerCharacter and localPlayerCharacter:FindFirstChild("HumanoidRootPart") then
                        ...
                        Library:Notify("[drac.cc] - Teleported to " .. SelectedPlayer.Name, 3)
                    else
                        Library:Notify("[drac.cc] - Unable to teleport: character not found", 3)
                    end
                else
                    Library:Notify("[drac.cc] - Unable to teleport: target's character not found", 3)
                end
            else
                Library:Notify("[drac.cc] - No target selected to teleport to", 3)
            end
...
-- // drac.cc VISUAL ENHANCEMENTS 🖤💜

-- Neon glow helper
local function addGlow(gui)
...
print("drac.cc visual pack loaded")
